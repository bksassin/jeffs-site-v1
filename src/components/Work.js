...
<div id="controls-carousel" className="relative w-[75vw] mx-11" data-carousel="static">
<h2 class="mb-8 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Recent Work</h2>
